...
/*! 
	\class WaitIndicator
	\brief The WaitIndicator class lets an application display a progress indicator to show that a lengthy task is under way.
...
public:
	WaitIndicator(QWidget *parent = 0);
